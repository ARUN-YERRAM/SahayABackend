...
// Initialize Firebase Admin with the Database URL from your .env file
admin.initializeApp({
...
/**
 * Cloud Function to send scheduled messages every minute.
 */
exports.sendScheduledMessages = functions.pubsub.schedule("every 1 minutes")
  .timeZone("Asia/Kolkata") // Optional: set your preferred time zone
  .onRun(async (context) => {
    const now = new Date();
    const currentTime = now.toLocaleTimeString("en-GB", { hour: "2-digit", minute: "2-digit" });
